...
public class TrainingSessionController {
  ...
  public ResponseEntity<GenericResponse<List<WorkoutExercise>>> validateTrainingSessionWithoutChange(
    @PathVariable("trainingParentId") Long trainingParentId,
    @PathVariable("trainingDate") @DateTimeFormat(pattern = "yyyy-MM-dd") Date trainingDate,
    @AuthenticationPrincipal UserDetailsImpl userDetails
  ) {
    List<WorkoutExercise> trainingExercises = this.trainingSessionService.validateTrainingSessionWithoutChange(trainingParentId, trainingDate, userDetails.getId());
  ...
  public ResponseEntity<GenericResponse<List<WorkoutExercise>>> modifyDataAndValidateTrainingSession(
    @PathVariable("trainingParentId") Long trainingParentId,
    @PathVariable("trainingDate") @DateTimeFormat(pattern = "yyyy-MM-dd") Date trainingDate,
    @RequestBody ModifyAndValidateRequest requestBody,
    @AuthenticationPrincipal UserDetailsImpl userDetails
  ) {
    List<WorkoutExercise> trainingExercises = this.trainingSessionService.modifyDataAndValidateTrainingSession(trainingParentId, trainingDate, requestBody, userDetails.getId());
