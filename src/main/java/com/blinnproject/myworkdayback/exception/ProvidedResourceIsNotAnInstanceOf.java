...
public class ProvidedResourceIsNotAnInstanceOf extends RuntimeException {
  private final String providedResourceName;
  private final String providedResourceValue;
  private final String instanceRequired;

  public ProvidedResourceIsNotAnInstanceOf(String providedResourceName, String providedResourceValue, String instanceRequired) {
  ...
  public ProvidedResourceIsNotAnInstanceOf() {
